      ...
      <section className="justify-center items-center mt-16 w-full mx-auto">
        ...
        <div className="text-center">
          <div className="font-Poppins  font-semibold text-4xl">
            <h1>Start Learning with
              <span className="text-background"> Uredx</span> and achieve your goals
            </h1>
          </div>
        ...
        <div className="container flex flex-col items-center pt-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center justify-center">
            ...
            >
              ...
              <div className="absolute w-[80px] z-0 inset-0 h-[75px] bg-background rounded-full -top-5 -left-5"></div>
            </div>
            {/* text container */}
            <div
              data-aos="fade-right"
